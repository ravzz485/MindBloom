...
class QuickCheckScreen extends StatefulWidget {
  ...
  @override
  State<QuickCheckScreen> createState() =>
    _QuickCheckScreenState();
}

class _QuickCheckScreenState extends
  State<QuickCheckScreen> {
  ...
  Future<void> submitAssessment() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('$baseUrl/assessment/quick'),
        headers: {
