...
class _RewardsScreenState extends State<RewardsScreen>
  ...
  List<Reward> _rewards = const [
    Reward(
      id: 'r1', title: 'Calm Mind',
      description: '10-min guided meditation session',
      pointsRequired: 100,
      status:  RewardStatus.claimed,
      icon:    Icons.self_improvement_rounded,
      iconColor: _C.brand,   iconBg: _C.brandSoft,
      borderColor: _C.brand, category: 'Wellness',
    ),
    Reward(
      id: 'r2', title: 'Sleep Story',
      description: 'Unlock a relaxing bedtime audio story',
      pointsRequired: 200,
      status:  RewardStatus.claimed,
      icon:    Icons.bedtime_rounded,
      iconColor: _C.blue,    iconBg: _C.blueBg,
      borderColor: _C.blue,  category: 'Sleep',
    ),
    Reward(
      id: 'r3', title: 'Journal Theme',
