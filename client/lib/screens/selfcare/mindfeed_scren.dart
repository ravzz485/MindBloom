            ...
            children: [
              ...
              Expanded(
                child: _memories.isEmpty
                    ? const Center(
                        child: Text('The jar is empty — add your first memory!',
        ...
        children: [
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: MBColors.darkGreen.withOpacity(0.4), width: 2.5),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('memories',
                          style: TextStyle(
                              fontSize: 13, color: MBColors.textSecondary)),
                    ],
                  ),
                ),
                const SizedBox(height: 8),
                const Text('Tap the jar to read them',
                    style: TextStyle(
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: const Text('Drop into the jar',
                      ...
                      child: Row(
                        children: [
                          ...
                          const Icon(Icons.open_in_new_rounded,
                              size: 18, color: MBColors.textSecondary),
                        ],
                      ),
                    ),
                  ),
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) => Container(
        ...
        child: Text(
          wellnessTips[i],
          style: const TextStyle(
              fontSize: 14.5, height: 1.4, color: MBColors.textPrimary),
        ),
      ),
    );
  }
