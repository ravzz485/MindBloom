...
const getBotResponse = (message) => {
  ...
  if (msg.includes("angry") || msg.includes("anger") ||
    ...
    return "It's okay to feel angry 😤 Try taking a short walk or doing some physical activity to release that energy. Deep breathing helps too! 🌬️";
  }
  ...
  if (msg.includes("breath") || msg.includes("breathing")) {
    return "Try box breathing! 🌬️ Inhale for 4 counts → Hold for 4 → Exhale for 4 → Hold for 4. Repeat 4 times. This calms your nervous system! 💙";
  }
  ...
  if (msg.includes("suicide") || msg.includes("kill myself") ||
    ...
    return "⚠️ I'm very concerned about you. Please reach out to a crisis helpline immediately. You matter and help is available! Please call emergency services or a trusted person RIGHT NOW! 💙";
  }
